...
Route::get('/Home',[App\Http\Controllers\ProductTableController::class, 'home']);
Route::get('/About',[App\Http\Controllers\ProductTableController::class, 'About']);
Route::get('/Contact',[App\Http\Controllers\ProductTableController::class, 'Contact']);
Route::get('/Gallery',[App\Http\Controllers\ProductTableController::class, 'Gallery']);
