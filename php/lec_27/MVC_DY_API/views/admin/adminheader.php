...
<head>
    ...
    <title>Drivin Admin  - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admindashboard">
                ...
                <div class="sidebar-brand-text mx-3">Drivin Admin</div>
            </a>
            ...
            <hr class="sidebar-divider">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <!-- <a class="collapse-item" href="allproduct">All products</a> -->
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsefour"
                        ...
                        <i class="fas fa-product fa-cog"></i>
                        <span>Ajax</span>
                    </a><i class="fa fa-product-hunt" aria-hidden="true"></i>
                    <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Todo Components:</h6>
                            <a class="collapse-item" href="ajaxtodo">Todo</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo $this->base_url;?>admin/img/undraw_profile_1.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo $this->base_url;?>admin/img/undraw_profile_2.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo $this->base_url;?>admin/img/undraw_profile_3.svg"
                                            alt="...">
