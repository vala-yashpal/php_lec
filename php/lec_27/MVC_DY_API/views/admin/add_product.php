                                    ...
                                    <div class="row g-3 ">
                                        <div class="col-sm-6 ">
                                            <div class="form-floating py-2">
                                                <input type="text" class="form-control border-0" value="" name="item_name" id="gname" placeholder="Item Name">
                                                <!-- <label for="gname">Yor Name</label> -->
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-floating py-2">
                                                <input type="number" class="form-control border-0" value="" name="item_price" id="price" placeholder="Item Price $">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating py-2">
                                                <textarea class="form-control border-0" name="item_desc" placeholder="Item Description"  id="Description" style="height: 100px"></textarea>
