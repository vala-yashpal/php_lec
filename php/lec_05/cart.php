                    ...
                    <div class="table-content">
                        ...
                        <div class="cart-image-box">
                            <div class="cart-images" id="image-3">
                                <img src='<?php echo $value['item-image']; ?>' style=' width:100px;height:100px'>
                            </div>
                        </div>
                        <h2 class="cart-item"><?php echo $value['item-name']; ?></h2>
                        <p class="cart-description"><?php echo $value['item-des']; ?></p>
                        </div>
                        <div class="cart-price">
                        <h3 class="price"><?php echo $value['item-price']; ?></h3>
                        </div>
                        <div class="cart-quantity">
                        <input type="text" name="cart-1-quantity" id="cart-1-quantity" value="<?php echo $value['item-quantity']; ?>"> 
                        </div>
